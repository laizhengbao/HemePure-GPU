    ...
    namespace lattices
    {
      class D3Q15 : public lb::lattices::Lattice<D3Q15>
      {
        public:
          ...
          static const distribn_t CXD[NUMVECTORS] __attribute__((aligned(64)));
          static const distribn_t CYD[NUMVECTORS] __attribute__((aligned(64)));
          static const distribn_t CZD[NUMVECTORS] __attribute__((aligned(64)));

          static const double EQMWEIGHTS[NUMVECTORS] __attribute__((aligned(64))); 
